...
import 'primereact/resources/themes/lara-light-blue/theme.css'; // Optional theme
...
export default function CheckboxRowSelectionDemo() {
  ...
  const fetchData = async (page: number) => {
    ...
    const apiItems = data.data as ArtworkApiItem[];

    const transformed: Product[] = apiItems.map((item) => ({
      id: item.id,
      code: item.id,
      name: item.title,
